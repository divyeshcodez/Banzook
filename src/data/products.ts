...
export const PRODUCTS: Product[] = [
  {
    ...
    price: 1499,
    images: ['/images/tshirt_hotwheels.jpg', '/images/model_hotwheels.jpg'],
    category: 'Tees',
    collection: 'Drop 001',
    sizes: ['S', 'M', 'L', 'XL'],
  ...
  },
  {
    ...
    price: 1299,
    images: ['/images/tshirt_kindmind.jpg', '/images/model_kindmind.png'],
    category: 'Tees',
    collection: 'Drop 001',
    sizes: ['S', 'M', 'L', 'XL'],
    availability: 'in-stock',
  ...
  },
  {
    ...
    price: 1499,
    images: ['/images/tshirt_legends.jpg', '/images/model_legends.png'],
    category: 'Tees',
    collection: 'Drop 001',
    sizes: ['S', 'M', 'L', 'XL', 'XXL'],
    availability: 'in-stock',
  ...
  },
  {
    ...
    price: 1399,
    images: ['/images/tshirt_brokensystem.jpg', '/images/model_brokensystem.png'],
    category: 'Tees',
    collection: 'Drop 001',
    sizes: ['S', 'M', 'L', 'XL'],
    availability: 'in-stock',
