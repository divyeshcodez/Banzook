...
export const JourneySection: React.FC = () => {
  ...
  return (
    <section id="journey" className="relative bg-[#080808] border-t border-[#2A2A27] overflow-hidden pt-32 pb-48">
      <div className="w-full max-w-7xl mx-auto px-4 md:px-8">
        
        {/* Section Header */}
        <div className="flex flex-col md:flex-row justify-between items-end mb-16 md:mb-24 w-full">
          <div>
            <div className="text-[#FF4D1A] text-[10px] md:text-xs font-bold tracking-[0.25em] uppercase mb-4 md:mb-6 border border-[#FF4D1A]/30 inline-block px-3 py-1.5 rounded-full shadow-[0_0_15px_rgba(255,77,26,0.15)]">
        ...
        <div className="flex flex-col gap-40 md:gap-52 lg:gap-64 pb-24 mt-20">
          {JOURNEY_STEPS.map((step, idx) => (
            <div
              key={idx}
              className="flex flex-col items-center gap-12 md:gap-16 w-full text-center"
            >
              
              {/* Image Side */}
              <div className="w-full md:w-2/3 lg:w-1/2 relative group mx-auto">
                ...
                {/* Handwritten Bubble */}
                <div className="absolute -right-4 md:-right-8 top-12 bg-[#F4F0E8] text-black text-[10px] md:text-xs px-4 py-2.5 rounded-lg border border-black/10 shadow-[4px_6px_0px_0px_rgba(255,75,31,0.9)] z-20 transform rotate-[4deg] font-mono font-bold max-w-[160px] md:max-w-[200px] text-center leading-tight transition-transform duration-300 group-hover:scale-105">
                  "{step.bubble}"
                </div>
              </div>

              {/* Content Side */}
              <div className="w-full md:w-2/3 lg:w-1/2 flex flex-col items-center justify-center text-center mx-auto">
                
                <div className="mb-8 md:mb-12">
                  <span className="text-[#FF4D1A] text-[10px] font-bold tracking-[0.25em] uppercase border border-[#FF4D1A]/30 px-3 py-1.5 rounded-full shadow-[0_0_10px_rgba(255,77,26,0.1)]">
                ...
                <p className="text-[#FF4D1A] text-sm md:text-base font-bold tracking-[0.2em] uppercase leading-relaxed mb-8">
                  {step.subtitle}
                </p>
                
                <p className="text-[#A39E98] text-lg md:text-xl lg:text-2xl font-serif italic font-medium leading-relaxed max-w-md mx-auto">
                  "{step.quote}"
                </p>
                ...
                <button 
                  ...
                  className="mt-12 group flex items-center justify-center gap-4 bg-transparent transition-all duration-300"
                >
                  <span className="text-white group-hover:text-[#FF4D1A] text-xs font-bold tracking-widest uppercase transition-colors">Explore Piece</span>
                  <div className="w-10 h-10 rounded-full border border-[#2A2A27] bg-[#161616] flex items-center justify-center text-white group-hover:border-[#FF4D1A] group-hover:text-[#FF4D1A] group-hover:shadow-[0_0_15px_rgba(255,77,26,0.3)] transition-all duration-300">
