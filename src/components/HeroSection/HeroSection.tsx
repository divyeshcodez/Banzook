...
const BANZOOK_DROPS: DropItem[] = [
  {
    ...
    mainImage: '/images/banzook_model_cinematic_hero.png',
    leftImage: '/images/model_nosmoking_front.jpg',
    rightImage: '/images/model_nosmoking_back.jpg',
    price: '₹1,299',
    productId: 'prod-14'
  },
  {
    ...
    mainImage: '/images/banzook_model_centerpiece.png',
    leftImage: '/images/banzook_phone_model.png',
    rightImage: '/images/model_brokensystem.png',
    price: '₹2,499',
    productId: 'prod-17'
  },
  {
    ...
    mainImage: '/images/model_nosmoking_pose.jpg',
    leftImage: '/images/model_nosmoking_split.jpg',
    rightImage: '/images/banzook_model_cinematic_hero.png',
    price: '₹1,299',
    productId: 'prod-14'
  },
  {
    ...
    mainImage: '/images/banzook_model_cinematic_zoom.png',
    leftImage: '/images/tshirt_brokensystem.jpg',
    rightImage: '/images/model_brokensystem.png',
    price: '₹1,399',
    productId: 'prod-17'
  },
  {
    ...
    mainImage: '/images/model_hotwheels.jpg',
    leftImage: '/images/tshirt_hotwheels.jpg',
    rightImage: '/images/banzook_model_centerpiece.png',
    price: '₹1,499',
    productId: 'prod-13'
  },
  {
    ...
    mainImage: '/images/model_legends.png',
    leftImage: '/images/tshirt_legends.jpg',
    rightImage: '/images/model_hotwheels.jpg',
    price: '₹1,499',
    productId: 'prod-16'
  },
  {
    ...
    mainImage: '/images/model_kindmind.png',
    leftImage: '/images/tshirt_kindmind.jpg',
    rightImage: '/images/banzook_model_cinematic_zoom.png',
    price: '₹1,299',
    productId: 'prod-15'
  },
  {
    ...
    mainImage: '/images/editorial_mumbai.png',
    leftImage: '/images/hero_campaign.png',
    rightImage: '/images/community_grid.png',
    price: '₹1,399',
    productId: 'prod-14'
  },
  {
    ...
    mainImage: '/images/outsider_bg.png',
    leftImage: '/images/creator_bg.png',
    rightImage: '/images/rebel_bg.png',
    price: '₹1,499',
    productId: 'prod-13'
  }
];
