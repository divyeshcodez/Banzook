...
export const ShopHeroStrip: React.FC = () => {
  const images = [
    { src: 'https://images.unsplash.com/photo-1542272201-b1ca555f8505?auto=format&fit=crop&w=800&q=80', shape: 'pill' },
    { src: 'https://images.unsplash.com/photo-1515886657613-9f3515b0c78f?auto=format&fit=crop&w=800&q=80', shape: 'rect' },
